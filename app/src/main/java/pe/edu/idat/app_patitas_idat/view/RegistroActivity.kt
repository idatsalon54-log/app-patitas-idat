...
import pe.edu.idat.app_patitas_idat.databinding.ActivityRegistroBinding
...
import pe.edu.idat.app_patitas_idat.util.TipoMensaje
...
class RegistroActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun obtenerResultadoRegistro(response: ResponseRegistro) {
        ...
        AppMensaje.enviarMensaje(binding.root,
            response.mensaje, TipoMensaje.SUCCESS)
